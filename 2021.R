...
# Sheets also have graphs

# Note: 2021 - 76 sites/sheet & 4 USGS sites/sheets
# Reading 2021 CRB data
library(readxl)  
...
print(file2021)
# Checking all sheets added 
print(sites2021)
length(sites2021)
# Read all sheets in 2021 Clackamas Data to list of data frame objects
# Each site/sheet is a dataframe object
