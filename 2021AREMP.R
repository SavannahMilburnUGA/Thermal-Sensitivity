...
# Apply analyzeDeploy function to 4 deploy sites
...
AREMP2021Summary
# Need to manually check AREMP2021Summary based on AREMP file
# Looks like 4 AREMP sites could only do: 9/17/2021 to 5/25/2021 ?
